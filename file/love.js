(function(window){
    ...
    Seed.prototype = {
        ...
        drawText: function() {
            ...
            ctx.fillText("Oo meri Pyari bachhii  :) ", 30, -5);
            ctx.fillText("click krna isko motiii ", 28, 10);
            ctx.restore();
        },
        clear: function() {
            var ctx = this.tree.ctx, cirle = this.cirle;
    ...
    Tree = function(canvas, width, height, opt) {
        ...
        this.initFooter();
        this.initBranch();
    // MARK: "Birthday Queen" appears in drawText() -> ctx.fillText("Moti !", 28, 10); // Line 120
        this.initBloom();
    }
    Tree.prototype = {
        initSeed: function() {
